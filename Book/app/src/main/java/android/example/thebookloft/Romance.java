...
public class Romance extends RecyclerView.Adapter<Romance.RomanceViewHolder> {
...
//    public interface BooksModifier{
    ...
    public Romance(Context context, ArrayList<Book> shelf, int ListPosition){
    ...
    @Override
    public void onBindViewHolder(@NonNull RomanceViewHolder holder, int position) {
        Log.v("Notice","onBindViewHolder");
        try{
            Book MoreDetails = shelf.get(position);

                    Log.v("Notice","RomanceInflated");
                    Picasso.with(context)
                            .load(MoreDetails.getBookImageForRomance())
                            .into(holder.bookPic);
                    holder.title.setText(MoreDetails.getTitleForRomance());
    ...
    public static class RomanceViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ImageView bookPic;
        TextView title;
        ...
        public void onClick(View v) {
            ...
            Intent WebsiteIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(item.getRomanceWebLink()));
